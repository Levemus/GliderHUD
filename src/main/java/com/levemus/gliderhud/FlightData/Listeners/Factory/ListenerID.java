...
public class ListenerID {
    ...
    public static final UUID BEARING = UUID.fromString("56e680e2-9f45-474a-bb10-1df4a786e1bf");
    public static final UUID VARIO = UUID.fromString("7434fd51-15b9-4f60-95d4-b22be8da047c");
