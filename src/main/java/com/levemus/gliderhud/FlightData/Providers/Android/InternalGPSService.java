...
public class InternalGPSService extends MessageService implements IIdentifiable, IChannelized {
    ...
    private InternalGPSServiceThread mWorkerThread = new InternalGPSServiceThread(TAG);
