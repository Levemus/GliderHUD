...
public class TestService extends MessageService implements IIdentifiable, IChannelized {
    ...
    private TestServiceThread mWorkerThread = new TestServiceThread(TAG);
