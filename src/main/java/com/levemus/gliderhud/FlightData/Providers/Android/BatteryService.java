...
public class BatteryService extends MessageService implements IIdentifiable, IChannelized {
    ...
    private BatteryServiceThread mWorkerThread = new BatteryServiceThread(TAG);
